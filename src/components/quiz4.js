...
const Quiz4 = (props) => {
    return (
        <Container className="Quiz4">

            <Card>
                <Col sm="12" md={{ size: 6, offset: 5 }}>
                    <Card.Title tag="h2">QUIZ 4</Card.Title>
                </Col>
                <br/>
                <Row>
                    <Col>
                        <Card body>
                            ...
                            <Card.Text>En France combiens de tonnes de nourriture seraient gaspillés dans la distribution ?</Card.Text>
                            <input name="q1" type="radio" id="r1" value="1" /><label
                            htmlFor="q1r1">+ 2,3 millions</label>
                            <br/>
                            <input name="q1" type="radio" id="r2" value="0"/><label
                            htmlFor="q1r2">+ 5.2 millions</label>
                        </Card>
                    </Col>
                    ...
                    <Col>
                        <Card body>
                            ...
                            <Card.Text>Combiens de tonnes au sein même des foyers ?</Card.Text>
                            <input name="q2" type="radio" id="r3" value="1" /><label
                            htmlFor="q1r1">6,5 millions</label>
                            <br/>
                    ...
                    <Col>
                        <Card body>
                            ...
                            <Card.Text>Une consommation responsable respecte l’environnementm mais aussi l’équité sociale et économique ?</Card.Text>
                ...
                <Row>
                    <Col>
                        <Card body>
                            ...
                            <Card.Text>Pour un kilo de blé il faut ... litres d’eau ?</Card.Text>
                            <input name="q4" type="radio" id="r7" value="1" /><label
                            htmlFor="q1r1">590</label>
                            <br/>
                            <input name="q4" type="radio" id="r8" value="0"/><label
                            htmlFor="q1r2">350</label>
                        </Card>
                    </Col>
                    ...
                    <Col>
                        <Card body>
                            ...
                            <Card.Text>le riz et les pâtes font également partie des denrées alimentaires
                                les plus souvent gaspillées ?</Card.Text>
                    ...
                    <Col>
                        <Card body>
                            ...
                            <Card.Text>La consommation durable est le fait de consommer d’une façon permettant de préserver au maximum nos ressources et l’environnement</Card.Text>
